#!/bin/bash
# KIST_ALL_FULL chunk COLMAP 파이프라인 (자동 모드 - confirm 제거)
# 실행 방법: bash colmap_chunk_auto.sh chunk_04
...
echo ""
echo "████████████████████████████████████████████████████████"
echo "  KIST_ALL_FULL COLMAP pipeline (AUTO)  [${CHUNK}]"
echo "  DB     : ${DB}"
echo "  IMAGES : ${IMAGES}"
echo "  GPU    : 0"
echo "████████████████████████████████████████████████████████"
...
step 1 "feature_extractor (GPU 0)"
...
step 2 "sequential_matcher (GPU 0)"
